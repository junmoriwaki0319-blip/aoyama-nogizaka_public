...
SEGMENT_DEFS = {
    "8058": {
        "name": "三菱商事",
        "segments": ["天然ガス", "総合素材", "石油・化学ソリューション", "金属資源",
                     "産業インフラ", "自動車・モビリティ", "食品産業", "S.L.C.",
                     "電力ソリューション", "複合都市開発"],
        "resource_segments": ["天然ガス", "金属資源"],
    },
    "8031": {
        "name": "三井物産",
    ...
    "8053": {
        "name": "住友商事",
        "segments": ["金属", "輸送機・建機", "インフラ", "メディア・デジタル",
                     "生活・不動産", "資源・化学品"],
        "resource_segments": ["金属", "資源・化学品"],
    },
    "8002": {
        "name": "丸紅",
