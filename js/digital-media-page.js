...
function rSubsector(){
  ...
  el.innerHTML=
    ...
    '<div class="commentary">'+
      ...
      '<strong>(1) 放送局のPBR 1.0倍割れ問題:</strong> 放送8社中6社がPBR 1.0倍未満（平均PBR 1.07倍）。OPM 14.8%と利益率は悪くないが、地上波広告の構造的縮小を市場が織り込んでいる。不動産含み益（フジ・メディアHD等）を含めると実質PBRはさらに低く、アクティビスト介入の蓋然性が高い。<br>'+
      '<strong>(2) 印刷・DXのバリュートラップ:</strong> DNP・凸版は時価総額2.5兆円だがPBR平均0.90倍。DX事業の成長は認められるものの、伝統的印刷事業の収縮を補えていない。カーブアウト/スピンオフがPBR改善の鍵。<br>'+
      '<strong>(3) プラットフォームの高PBR vs 低ROE:</strong> プラットフォーム19社のPBR平均3.28倍だがROE平均0.1%。成長期待で買われているが収益性が伴っていない。LINEヤフー以外のプラットフォーム企業は黒字化の道筋の明示が急務。<br>'+
      '<strong>(4) アドテックの高収益性:</strong> 平均OPM 11.8%・ROE 17.4%と財務効率が最も高いカテゴリ。ただし時価総額は972億円と小さく、ロールアップM&Aの対象になりやすい構造。'+
    '</div>'+
    '<div class="kpi-grid">'+
