...
(() => {
  ...
  function rExec() {
    ...
    el.innerHTML = `
      ...
      <div class="commentary">
        ...
        <strong>トレンド更新 (${DATA_AS_OF.trendUpdate}): 戦争影響による原材料費高騰の"節目"</strong><br>
        中東情勢の緊迫化(イラン紛争・紅海物流リスク)とウクライナ戦争の長期化を背景に、コーヒー生豆(2025年にアラビカ・ロブスタ両品種が過去最高値を更新)、小麦、肥料用尿素、輸送燃料のいずれもが高止まり。
        一方で<strong>コーヒー相場は2026年2月以降、6年ぶりの需給緩和観測</strong>からピークアウトが視野に入り、小売店頭価格の高止まりと仕入コスト低下のタイムラグが各社業績を分岐させる局面に入った。
        国内でも2026年1～4月に<strong>1,044品目の値上げ</strong>が予定され、最低賃金は2024年に<strong>全国加重平均1,055円</strong>(${DATA_AS_OF.minimumWage})に到達。人件費率30-40%×賃金上昇率約5%で<strong>営業利益の数%〜十数%</strong>の下押し圧力と試算される(自社推計、業態により幅あり)。<br><br>

        <strong>各社の対応分化(代表例):</strong><br>
        ・<strong>コメダHD(3543)</strong>: 株価が年初来高値を更新、SMBC日興が目標株価を<strong>3,400円に引き上げ</strong>(2026年4月17日)。2027年2月期から<strong>都市部のビル内店舗</strong>を中心に出店することで当面の出店数・収益性を確保。コーヒー豆価格下落の恩恵は<strong>28年2月期以降</strong>に顕在化する見通しで、「不確実性が高い環境下でも安定的な増益や株価推移が続いており、強気の投資判断を継続」と評価(出所: 日経)。<br>
        ・<strong>サイゼリヤ</strong>: 国内大手ファミレスで唯一<strong>値上げを見送り</strong>、アイドルタイム活用等のオペレーション改革で2026年8月期は3年連続最高益の見通し。値上げ疲れの消費者を取り込む逆張り戦略。<br>
        ・<strong>日本マクドナルドHD</strong>: 2025年3月にハンバーガー170→190円の価格改定と同時に<strong>500円台セット</strong>を導入し、客単価維持と来店頻度維持を両立。<br>
        ・<strong>コーヒー系(UCC等)</strong>: 業務用・家庭用レギュラーコーヒーで<strong>10～18%の価格改定</strong>を順次実施、喫茶・カフェ業態の仕入コスト上昇圧力が継続。<br><br>

        <strong>郊外型FR</strong>は客数減少トレンド(人口動態変化・デリバリーの代替進行)に加え、米価指数の前年比+38%(2015年基準120→166)が値上げ転嫁の上限を規定する構造的課題。<br>
        <strong>企業選別の提言:</strong> (1)ブランド力に裏打ちされた<strong>価格転嫁力</strong>、(2)<strong>立地・業態転換</strong>によるトラフィック確保(郊外型→都市部ビル内への出店シフト等)、(3)<strong>海外展開</strong>による為替ヘッジと成長余地、(4)<strong>DX・省人化投資</strong>によるコスト構造改革、(5)コーヒー・小麦の<strong>原材料相場ピークアウト恩恵</strong>を享受し得る業態(喫茶・パン・ピザ等)の5軸を重視。
      </div>
      <div class="kpi-grid">
  ...
  function rMacro() {
    ...
    el.innerHTML = `
      ...
      <div class="commentary">
        <strong>外部環境 (${DATA_AS_OF.trendUpdate}更新):</strong> 米価は2024年に<strong>指数166</strong>(2015年10月=100基準、前年比+38%)と急騰(「令和の米騒動」、小売店頭価格ベースでは約1.8倍)。
        中東情勢の緊迫化とウクライナ戦争の長期化を受け、<strong>コーヒー生豆は2025年にアラビカ・ロブスタ両品種が過去最高値</strong>、小麦・肥料用尿素・輸送燃料も高止まり。
        もっとも<strong>コーヒー相場は2026年2月以降、6年ぶりの需給緩和観測</strong>でピークアウトが視野に入り、UCC等は業務用・家庭用レギュラーコーヒーで10～18%の価格改定を順次実施。小売店頭価格は高止まりが継続する見通し。
